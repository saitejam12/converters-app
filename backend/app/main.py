...
app = FastAPI(
    title="A frontend only application which will allow users",
    description="Build a frontend only application which will allow users to convert all types measurements into other types. Example categories  distances, weights, liquids, time, time zones, electricity etc. List the most commonly used conversions and add them to the app. keep it minimal",
    version="0.1.0",
)
